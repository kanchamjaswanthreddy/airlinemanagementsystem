...
public class Journey_Details extends JFrame{
	 ...
	 JTable table;
	    JLabel ReservationDetails,Booking_ref,Ticketid,Fcode,Jnydate,Jnytime,Source,Destination,label,label1;
	    JButton Show;
		...
		Booking_ref = new JLabel("BOOKING_REF");
		Booking_ref.setFont(new Font("Tahoma", Font.PLAIN, 13));
		Booking_ref.setBounds(79, 270, 83, 20);
		add(Booking_ref);
		...
		Show.addActionListener(new ActionListener(){
			...
			try{
	                    ...
	                    String str = "select booking_ref,ticket_id,f_code,jny_date,jny_time,src,dst from reservation where src = '"+src+"' and dst = '"+dst+"'";
