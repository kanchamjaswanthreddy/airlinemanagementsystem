...
public class Cancel extends JFrame{
	...
	JLabel PassengerNo = new JLabel("BOOKING REFERENCE");
	...
	add(textField_4);
        ...
        Cancel.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                ...
                String booking_ref = textField.getText();
		...
		try{	
                    conn c = new conn();
                    String str = "INSERT INTO cancellation values('"+booking_ref+"', '"+cancellation_no+"', '"+cancellation_date+"', '"+ticket_id+"', '"+flight_code+"')";
