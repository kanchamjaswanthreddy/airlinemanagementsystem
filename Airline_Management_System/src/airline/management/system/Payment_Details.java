...
public class Payment_Details extends JFrame{
	 ...
	 JTextField textField;
		...
		JLabel Fcode = new JLabel("BOOKING_REF");
		...
		FlightCode = new JLabel("BOOKING_REF");
		...
		Show.addActionListener(new ActionListener(){
	            public void actionPerformed(ActionEvent ae){
	                ...
	                try {
	                    ...
	                    conn c = new conn();
	                    String str = "select booking_ref,paid_amt,pay_date,cheque_no,card_no,ph_no from payment where pnr_no = '"+code+"'";
